...
export function AddPageMenu({ navigation }) {
    ...
    const sendMenu = () => {
        axios
            .post("http://192.168.1.143:5000/restaurant/menu/add", datas, {
        ...
        <View style={styles.container}>
            ...
            <Animated.View
                ...
                <View style={styles.dodajStoliki}>
                    <Text style={styles.txtStyle1}>Dodaj zdjęcie MENU</Text>
                </View>
                <View>
